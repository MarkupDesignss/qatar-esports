...
<div class="container-fluid px-2 px-sm-3 px-md-4 py-4">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white py-2 py-sm-3">
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-2">
                <h4 class="mb-0 h5 h4-sm fw-bold text-gray-800">
                    <i class="bi bi-pencil-square me-2 text-primary"></i>Edit News Type
                </h4>
        ...
        <div class="card-body p-3 p-sm-4">
            <form action="{{ route('admin.news-types.update', $newsType) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ $newsType->slug }}" 
                                   readonly disabled>
                            <small class="text-muted d-block mt-1">Slug is auto-generated and cannot be changed</small>
                        </div>
                            ...
                            <div class="card-body p-3 p-sm-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        <input type="checkbox" 
                                               ...
                                               value="1" 
                                               id="statusSwitch"
                                               {{ old('is_active', $newsType->is_active) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-semibold" for="statusSwitch">
                                            <span id="statusLabel" class="badge {{ old('is_active', $newsType->is_active) ? 'bg-success' : 'bg-danger' }}">
                                                {{ old('is_active', $newsType->is_active) ? 'Active' : 'Inactive' }}
                                            </span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('sort_order', $newsType->sort_order) }}"

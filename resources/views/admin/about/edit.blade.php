        ...
        <div class="card-header bg-white py-2 py-sm-3">
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-2">
                <h4 class="mb-0 h5 h4-sm fw-bold text-gray-800">
                    <i class="bi bi-pencil-square me-2 text-primary"></i>Edit About Section
                </h4>
                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="type" class="form-select form-select-sm @error('type') is-invalid @enderror" required>
                                ...
                                <option value="goals" {{ old('type', $section->type) == 'goals' ? 'selected' : '' }}>Goals</option>
                            </select>
                            ...
                            <div class="card-body p-3 p-sm-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($section->video_url)
                                        <div class="mt-1">
                                            <a href="{{ $section->video_url }}" target="_blank" class="text-decoration-none small">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-select form-select-sm">
                                        <option value="1" {{ old('status', $section->status) ? 'selected' : '' }}>Active</option>
                                        <option value="0" {{ old('status', $section->status) ? '' : 'selected' }}>Inactive</option>
                                    </select>
                                </div>

...
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col">
            <h4 class="page-title">Team Registrations</h4>
        </div>
    </div>
                        ...
                        @forelse($tournaments as $tournament)
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <a href="{{ route('admin.tournament-registrations.team-detail', $tournament->id) }}" class="btn btn-sm btn-primary">View Details</a>
                                </td>
                            </tr>
                        @empty
                            <tr>

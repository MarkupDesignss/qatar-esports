        ...
        <div class="card-header bg-white py-2 py-sm-3">
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-2">
                <h4 class="mb-0 h5 h4-sm fw-bold text-gray-800">
                    <i class="bi bi-plus-circle me-2 text-primary"></i>Create Partner
                </h4>
                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted d-block mt-1">
                                ...
                                Supported formats: PNG, JPG, JPEG, SVG, WEBP (Recommended: 200x200px, transparent background)
                            </small>
                        </div>
                            ...
                            <div class="card-body p-3 p-sm-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="form-check form-switch">
                                        ...
                                        <label class="form-check-label fw-semibold" for="statusSwitch">
                                            <span id="statusLabel" class="badge {{ old('status', '1') == '1' ? 'bg-success' : 'bg-danger' }}">
                                ...
                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn btn-success btn-sm">
                                        <i class="bi bi-check-circle me-1"></i> Create Partner
                                    </button>

...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <a href="#"
            ...
            <p class="text-4xl font-bold mt-4 text-white">0</p>
            <p class="text-sm text-white/80 mt-2">Total active tournaments</p>
        </a>

        {{-- Total Items --}}
        <a href="#"
            class="relative bg-gradient-to-br from-yellow-500 to-amber-500 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden">
            <div class="absolute top-0 right-0 w-24 h-24 bg-white/10 rounded-full -mr-12 -mt-12"></div>

            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-white">Inactive Tournaments</h3>
                <i class="bi bi-box-seam text-white text-xl"></i>
            </div>

            <p class="text-4xl font-bold mt-4 text-white">0</p>
            <p class="text-sm text-white/80 mt-2">Blocked / inactive tournaments</p>
        </a>

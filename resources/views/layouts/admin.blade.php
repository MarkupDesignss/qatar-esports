...
<body>
    ...
    <header class="main-header">
        <div class="header-left">
            ...
            <div class="logo-container">
                <!-- <div class="logo"></div> -->
                <div class="brand-text">Qatar Esports Admin</div>
            </div>
        </div>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-nav">
            ...
            <div class="nav-item dropdown-sidebar {{ request()->is('admin/partners*','admin/events*','admin/challenge*','admin/matches*','admin/previous-works*','admin/services*','admin/news*','admin/about*') ? 'open' : '' }}">

                <a href="javascript:void(0)"
                class="nav-link dropdown-toggle">
                    <i class="nav-icon bi bi-speedometer2"></i>
                    <span class="nav-label">Homepage Sections</span>
                    {{-- <i class="bi bi-chevron-down ms-auto"></i> --}}
                </a>
                ...
                <div class="dropdown-menu-sidebar">
                    ...
                    class="dropdown-item {{ request()->is('admin/events*') ? 'active' : '' }}">
                        Featured Events
                    </a>
